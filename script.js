...
class Portfolio {
    ...
    translations = {
        fr: {
            ...
            "hero-description": "Passionné par l'informatique depuis l'âge de 10 ans, je combine développement technique et analyse de données. Musicien amateur (batterie, piano, basse) et amateur de jazz.",
            "nav-brand": "xFufly",
            "nav-about": "À propos",
        ...
        en: {
            ...
            "hero-description": "Passionate about computer science since age 10, I combine technical development and data analysis. Amateur musician (drums, piano, bass) and jazz enthusiast.",
            "nav-brand": "xFufly",
            "nav-about": "About",
